...
t.add("victoire.config.global.metaTitlePattern.invalid", "You need at least <strong>%page.title%<\/strong>", "validators", "es");
t.add("victoire.config.json.invalid", "\u26a0 An error occured. Be sure it's valid JSON : <a href=\"http:\/\/json.parser.online.fr\/\">Online JSON validator<\/a>", "validators", "es");
t.add("victoire.config.global.organizationJsonLD.invalid", "\u26a0 An error occured. Be sure it's valid JSON-LD : <a href=\"https:\/\/json-ld.org\/playground\/\">JSON-LD Playground<\/a>", "validators", "es");
t.add("victoire.config.global.organizationJsonLD.missingType", "\u26a0 Semantical JSON-LD needs type. <a href=\"http:\/\/schema.org\/Organization\">eg. Organization<\/a>", "validators", "es");
t.add("victoire.config.global.organizationJsonLD.invalidContext", "\u26a0 Semantical JSON-LD needs context. <a href=\"https:\/\/developers.google.com\/search\/docs\/guides\/intro-structured-data\">https:\/\/schema.org<\/a>", "validators", "es");
})(Translator);
