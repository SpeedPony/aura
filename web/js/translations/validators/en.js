...
t.add("victoire.config.global.metaTitlePattern.invalid", "You need at least %page.title%", "validators", "en");
t.add("victoire.config.json.invalid", "An error occured. Be sure it's valid JSON : <a href=\"http:\/\/json.parser.online.fr\/\">Online JSON validator<\/a>", "validators", "en");
t.add("victoire.config.global.organizationJsonLD.invalid", "An error occured. Be sure it's valid JSON-LD : <a href=\"https:\/\/json-ld.org\/playground\/\">JSON-LD Playground<\/a>", "validators", "en");
t.add("victoire.config.global.organizationJsonLD.missingType", "Semantical JSON-LD needs type. <a href=\"http:\/\/schema.org\/Organization\">eg. Organization<\/a>", "validators", "en");
t.add("victoire.config.global.organizationJsonLD.invalidContext", "Semantical JSON-LD needs context. <a href=\"https:\/\/developers.google.com\/search\/docs\/guides\/intro-structured-data\">https:\/\/schema.org<\/a>", "validators", "en");
})(Translator);
