...
t.add("victoire.config.global.metaTitlePattern.invalid", "Il est obligatoire de garder \u00e0 minima %page.title%", "validators", "fr");
t.add("victoire.config.json.invalid", "Une erreur est survenue avec la valeur entr\u00e9e. Assurez-vous qu'il s'agisse bien de JSON valide : <a href=\"http:\/\/json.parser.online.fr\/\">Validateur en ligne<\/a>", "validators", "fr");
t.add("victoire.config.global.organizationJsonLD.invalid", "Une erreur est survenue avec le JSON entr\u00e9. Assurez-vous qu'il s'agisse bien de JSON-LD valide : <a href=\"https:\/\/json-ld.org\/playground\/\">JSON-LD Playground<\/a>", "validators", "fr");
t.add("victoire.config.global.organizationJsonLD.missingType", "Il semble manquer le type. Assurez-vous qu'il soit pr\u00e9sent : <a href=\"http:\/\/schema.org\/Organization\">Exemple: type Organization<\/a>", "validators", "fr");
t.add("victoire.config.global.organizationJsonLD.invalidContext", "Il semble manquer le contexte. Assurez-vous qu'il soit pr\u00e9sent : <a href=\"https:\/\/developers.google.com\/search\/docs\/guides\/intro-structured-data\">https:\/\/schema.org<\/a>", "validators", "fr");
})(Translator);
